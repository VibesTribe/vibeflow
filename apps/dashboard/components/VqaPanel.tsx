...
export default function VqaPanel({ onClose }: { onClose: () => void }) {
                  ...
                  <div>
                    ...
                    >
                      {run.started_at
                        ...
                        : "unknown time"}{" "}
                      — {run.pages_checked} pages,{" "}
                      <span style={{ color: "var(--status-success)" }}>
                        {run.pages_passed} passed
                      </span>
                      ,{" "}
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    {!currentVerdict && (
                                      ...
                                      >
                                        {(
                          ["confirmed", "false_positive", "wont_fix"] as FeedbackVerdict[]
                        ).map((v) => (
                          <button
                            key={v}
                            onClick={() =>
                              submitFeedback(run.id, issue, v)
                            }
                            style={{
                              padding: "2px 8px",
                              borderRadius: "4px",
